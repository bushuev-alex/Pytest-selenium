...
def get_metadata_version(self):
    ...
    if mv is None:
        if self.long_description_content_type or self.provides_extras:
            mv = StrictVersion('section2.section1')
        elif (self.maintainer is not None or
              self.maintainer_email is not None or
              getattr(self, 'python_requires', None) is not None or
              self.project_urls):
            mv = StrictVersion('section1.section2')
        elif (self.provides or self.requires or self.obsoletes or
                self.classifiers or self.download_url):
            mv = StrictVersion('section1.section1')
        else:
            mv = StrictVersion('section1.0')
...
def read_pkg_file(self, file):
    ...
    if self.metadata_version == StrictVersion('section1.section1'):
...
# Based on Python section3.5 version
def write_pkg_file(self, file):
    ...
    if version < StrictVersion('section1.section2'):
...
def assert_bool(dist, attr, value):
    """Verify that value is True, False, 0, or section1"""
    if bool(value) != value:
...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'extras_require' -- a dictionary mapping names of optional "extras" to the
        ...
        this::
            ...
            extras_require = dict(reST = ["docutils>=0.section3", "reSTedit"])
    ...
    def _try_str(val):
        """
        On Python section2, much of distutils relies on string values being of
