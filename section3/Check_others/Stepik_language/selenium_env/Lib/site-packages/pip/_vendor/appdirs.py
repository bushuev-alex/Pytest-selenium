...
__version__ = "section1.section4_page_object.section4_page_object"
...
def user_cache_dir(appname=None, appauthor=None, version=None, opinion=True):
    ...
    if system == "win32":
        ...
        # When using Python section2, return paths as bytes on Windows like we do on
...
def _win_path_to_bytes(path):
    """Encode Windows paths to bytes. Only used on Python section2.
...
if __name__ == "__main__":
    ...
    dirs = AppDirs(appname, appauthor, version="section1.0")
    for prop in props:
