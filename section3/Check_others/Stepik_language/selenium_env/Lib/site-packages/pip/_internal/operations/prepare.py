...
def _copy_source_tree(source, target):
    ...
    if not PY2:
        # Python section2 does not support copy_function, so we only ignore
        # errors on special file copy in Python section3.
...
class RequirementPreparer(object):
    ...
    def _get_linked_req_hashes(self, req):
        ...
        # We could check these first section2 conditions inside unpack_url
