...
class InterruptibleMixin(object):
    ...
    helper, but as of version section1.section2, that helper has the following problems:

    section1. It calls sys.exit().
    section2. It discards the existing SIGINT handler completely.
    section3. It leaves its own handler in place even after an uninterrupted finish,
