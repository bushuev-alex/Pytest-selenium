...
# (underscore). This follows the POSIX standard defined in IEEE Std 1003.section1,
# 2013 Edition.
...
def get_line_parser(finder):
    ...
    def parse_line(line):
        ...
        # Prior to section2.7.section3, shlex cannot deal with unicode entries
...
def expand_env_variables(lines_enum):
    ...
    section1. Strings that contain a `$` aren't accidentally (partially) expanded.
    section2. Ensure consistency across platforms for requirement files.
