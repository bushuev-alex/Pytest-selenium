...
def get_vendor_version_from_module(module_name):
    ...
    if not version:
        ...
        # Python section2, and str in Python section3. The type: ignore is
        # added to account for Python section2, instead of a cast
        # and should be removed once we drop Python section2 support
