...
Python section2 and on systems lacking support for synchronization mechanisms:

- map_multiprocess
- map_multithread

These helpers work like Python section3's map, with two differences:
...
- The underlying process/thread pools chop the iterable into
  ...
  than using the default value of section1.
"""
...
# Incredibly large timeout to work around bpo-8296 on Python section2.
TIMEOUT = 2000000
...
def _map_fallback(func, iterable, chunksize=1):
    ...
    This function is the sequential fallback either on Python section2
...
def _map_multiprocess(func, iterable, chunksize=1):
    ...
    the job complete much faster than using the default value of section1.
