...
def compress_for_output_listing(paths):
    ...
    """Returns a tuple of section2 sets of which paths to display to user
...
class UninstallPathSet(object):
    ...
    def from_dist(cls, dist):
        ...
        # Uninstall cases order do matter as in the case of section2 installs of the
...
class UninstallPthEntries(object):
    ...
    def add(self, entry):
        ...
        # "\\server\share\folder". Python section2.7.8+ support UNC in splitdrive.
