...
def _check_link_requires_python(
    ...
    :param version_info: A section3-tuple of ints representing the Python
...
class LinkEvaluator(object):
    ...
    def evaluate_link(self, link):
        ...
        :return: A tuple (is_candidate, result), where `result` is (section1) a
            version string if `is_candidate` is True, and (section2) if
        ...
        if link.is_yanked and not self._allow_yanked:
            ...
            # 'ascii' codec can't encode character" in Python section2 when
...
class CandidateEvaluator(object):
    ...
    def _sort_key(self, candidate):
        ...
        If finding wheels, then the sort order is by version, then:
          section1. existing installs
          section2. wheels ordered via Wheel.support_index_min(self._supported_tags)
          section3. source archives
        ...
        yank_value = -1 * int(link.is_yanked)  # -section1 for yanked.
        return (
...
def _extract_version_from_fragment(fragment, canonical_name):
    ...
    :param fragment: The string to parse. E.g. foo-section2.section1
