...
class Git(VersionControl):
    ...
    def get_git_version(self):
        ...
        if version.startswith(VERSION_PFX):
            ...
            version = ''
        # get first section3 positions of the git version because
    ...
    def get_current_branch(cls, location):
        ...
        # command to exit with status code section1 instead of 128 in this case
    ...
    def update(self, dest, url, rev_options):
        ...
        if self.get_git_version() >= parse_version('section1.9.0'):
    ...
    def get_remote_url(cls, location):
        ...
        url configured.
        """
        # We need to pass section1 for extra_ok_returncodes since the command
        # exits with return code section1 if there are no matching lines.
