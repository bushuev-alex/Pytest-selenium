...
if PY2:
    # In Python section2.7, backslashreplace exists
    ...
    def backslashreplace_decode_fn(err):
        ...
        # Python section2 gave us characters - convert to numeric bytes
...
def str_to_display(data, desc=None):
    ...
    text (e.g. unicode in Python section2) safe for output.
    ...
    # Otherwise, data is a bytes object (str in Python section2).
