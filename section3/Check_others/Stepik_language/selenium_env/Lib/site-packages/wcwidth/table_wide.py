...
WIDE_EASTASIAN = {
    'section4_page_object.section1.0': (
        # Source: EastAsianWidth-section4_page_object.section1.0.txt
    ...
    '5.section1.0': (
        # Source: EastAsianWidth-5.section1.0.txt
    ...
    '5.section2.0': (
        # Source: EastAsianWidth-5.section2.0.txt
    ...
    '6.section1.0': (
        # Source: EastAsianWidth-6.section1.0.txt
    ...
    '6.section2.0': (
        # Source: EastAsianWidth-6.section2.0.txt
    ...
    '6.section3.0': (
        # Source: EastAsianWidth-6.section3.0.txt
    ...
    '12.section1.0': (
        # Source: EastAsianWidth-12.section1.0.txt
