...
ZERO_WIDTH = {
    'section4_page_object.section1.0': (
        # Source: DerivedGeneralCategory-section4_page_object.section1.0.txt
        ...
        (0x0fe00, 0x0fe0f,),  # Variation Selector-section1    ..Variation Selector-16
    ...
    '5.section1.0': (
        # Source: DerivedGeneralCategory-5.section1.0.txt
    ...
    '5.section2.0': (
        # Source: DerivedGeneralCategory-5.section2.0.txt
    ...
    '6.section1.0': (
        # Source: DerivedGeneralCategory-6.section1.0.txt
    ...
    '6.section2.0': (
        # Source: DerivedGeneralCategory-6.section2.0.txt
    ...
    '6.section3.0': (
        # Source: DerivedGeneralCategory-6.section3.0.txt
    ...
    '12.section1.0': (
        # Source: DerivedGeneralCategory-12.section1.0.txt
