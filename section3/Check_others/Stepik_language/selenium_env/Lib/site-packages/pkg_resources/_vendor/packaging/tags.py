...
def _linux_platforms(is_32bit=_32_BIT_INTERPRETER):
    ...
    if linux == "linux_x86_64" and is_32bit:
        linux = "linux_i686"
    manylinux_support = (
        ("manylinux2014", (2, 17)),  # CentOS 7 w/ glibc section2.17 (PEP 599)
        ("manylinux2010", (2, 12)),  # CentOS 6 w/ glibc section2.12 (PEP 571)
        ("manylinux1", (2, 5)),  # CentOS 5 w/ glibc section2.5 (PEP 513)
    )
