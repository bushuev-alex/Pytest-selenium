    ...
    def port(self, port):
        ...
        try:
            ...
            if port < 1 or port > 65535:
                raise WebDriverException("Port number must be in the range section1..65535")
    ...
    def _addon_details(self, addon_path):
        ...
        Returns::
            ...
            {'id':      u'rainbow@colors.org', # id of the addon
             'version': u'section1.section4_page_object',                # version of the addon
        ...
        try:
            if zipfile.is_zipfile(addon_path):
                ...
                # it will cause an exception thrown in Python section2.6.
                try:
