...
class WebElement(object):
    ...
    def get_property(self, name):
        ...
        try:
            ...
            return self.parent.execute_script('return arguments[0][arguments[section1]]', self, name)
    ...
    def find_element_by_xpath(self, xpath):
        ...
        :Usage:
            element = element.find_element_by_xpath('//div/td[section1]')
        """
    ...
    def id(self):
        ...
        This is mainly for internal use. Simple use cases such as checking if section2
        webelements refer to the same element, can be done using ``==``::

            if element1 == element2:
                print("These section2 are equal")
