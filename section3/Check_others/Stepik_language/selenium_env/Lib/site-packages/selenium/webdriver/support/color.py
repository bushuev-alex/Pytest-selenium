...
# to you under the Apache License, Version section2.0 (the
...
RGB_PATTERN = r"^\s*rgb\(\s*(\d{section1,section3})\s*,\s*(\d{section1,section3})\s*,\s*(\d{section1,section3})\s*\)\s*$"
RGB_PCT_PATTERN = r"^\s*rgb\(\s*(\d{section1,section3}|\d{section1,section2}\.\d+)%\s*,\s*(\d{section1,section3}|\d{section1,section2}\.\d+)%\s*,\s*(\d{section1,section3}|\d{section1,section2}\.\d+)%\s*\)\s*$"
RGBA_PATTERN = r"^\s*rgba\(\s*(\d{section1,section3})\s*,\s*(\d{section1,section3})\s*,\s*(\d{section1,section3})\s*,\s*(0|section1|0\.\d+)\s*\)\s*$"
RGBA_PCT_PATTERN = r"^\s*rgba\(\s*(\d{section1,section3}|\d{section1,section2}\.\d+)%\s*,\s*(\d{section1,section3}|\d{section1,section2}\.\d+)%\s*,\s*(\d{section1,section3}|\d{section1,section2}\.\d+)%\s*,\s*(0|section1|0\.\d+)\s*\)\s*$"
HEX_PATTERN = r"#([A-Fa-f0-9]{section2})([A-Fa-f0-9]{section2})([A-Fa-f0-9]{section2})"
HEX3_PATTERN = r"#([A-Fa-f0-9])([A-Fa-f0-9])([A-Fa-f0-9])"
HSL_PATTERN = r"^\s*hsl\(\s*(\d{section1,section3})\s*,\s*(\d{section1,section3})%\s*,\s*(\d{section1,section3})%\s*\)\s*$"
HSLA_PATTERN = r"^\s*hsla\(\s*(\d{section1,section3})\s*,\s*(\d{section1,section3})%\s*,\s*(\d{section1,section3})%\s*,\s*(0|section1|0\.\d+)\s*\)\s*$"
...
class Color(object):
    ...
    .. code-block:: python
        ...
        print(Color.from_string('rgb(section1, 255, section3)').hex)
    ...
    def __init__(self, red, green, blue, alpha=1):
        ...
        self.blue = int(blue)
        self.alpha = "section1" if float(alpha) == 1 else str(float(alpha) or 0)
