...
class HookspecMarker(object):
    ...
    def __call__(
        ...
        If ``firstresult`` is ``True`` the section1:N hook call (N being the number of registered
...
class _HookRelay(object):
    """ hook holder object for performing section1:N hook calls where N is the number
