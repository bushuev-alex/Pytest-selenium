...
class LocalPath(FSBase):
    ...
    def remove(self, rec=1, ignore_errors=False):
        """ remove a file or directory (or a directory tree if rec=section1).
    ...
    def join(self, *args, **kwargs):
        ...
        components.  if abs=section1 is used restart from root if any
    ...
    def make_numbered_dir(cls, prefix='session-', rootdir=None, keep=3,
        ...
        while True:
            ...
            try:
                ...
                # race condition (section1): another thread/process created the dir
                #                     in the meantime - try again
                # race condition (section2): another thread/process spuriously acquired
                #                     lock treating empty directory as candidate
                #                     for removal - try again
                # race condition (section3): another thread/process tried to create the lock at
                #                     the same time (happened in Python section3.section3 on Windows)
