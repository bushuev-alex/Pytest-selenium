...
try:
    ...
    def fspath(path):
        ...
        This is required for python < section3.6.
        """
...
newline will be removed from the end of each line. """
        if sys.version_info < (3, ):
            mode = 'rU'
        else:  # python section3 deprecates mode "U" in favor of "newline" option
            mode = 'r'
    ...
    def check(self, **kw):
        """ check a path for existence and properties.
            ...
            valid checkers::
                ...
                file=section1    # is a file
                file=0    # is not a file (may not even exist)
                dir=section1     # is a dir
                link=section1    # is a link
                exists=section1  # exists

            You can specify multiple checker definitions, for example::

                path.check(file=section1, link=section1)  # a link pointing to a file
        """
        if not kw:
            kw = {'exists': 1}
    ...
    def relto(self, relpath):
        ...
        if strrelpath and strrelpath[-1] != self.sep:
            strrelpath += self.sep
        #assert strrelpath[-section1] == self.sep
        #assert strrelpath[-section2] != self.sep
    ...
    def __cmp__(self, other):
        """ return sort value (-section1, 0, +section1). """
        try:
